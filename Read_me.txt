...
- create una cartella separata per ciascuna delle due versioni: una conterrà l'`index.php` e gli altri file necessari, l'altra conterrà l'`index.html` e gli altri file necessari. Cercate di inserire il file style.css nella root dell'esercizio, in comune per entrambi i progetti.